...
def move_arms():
    ...
    # poseR_grab = np.array([-0.25, -.75, 0.75, -1., -.5, 0.]) * np.pi
    # move_to_joint_configuration_blocking(Rarm, poseR_grab)


    # poseR_grab = np.array([-0.75, -.5, 0., -.5, 0., 0.]) * np.pi
    # move_to_joint_configuration_blocking(Rarm, poseR_grab)
